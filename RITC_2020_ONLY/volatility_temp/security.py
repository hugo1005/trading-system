...
class Security:
    ...
    """ _______ VOL CASE ______ """


class Options(Security):

    def __init__(self, ticker, api, poll_delay=0.01, is_currency=False):
        super().__init__( ticker, api, poll_delay=0.01,is_currency) #calls all of the arguments from the super class 'Security'
    ...
    def vanilla(self, S, K, T, r, sigma, option = 'C',ticker):
    ...
    def nr_imp_vol(self,S, K, T, f, r, sigma, option = 'C' ,ticker):   
