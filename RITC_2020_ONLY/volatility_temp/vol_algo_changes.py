...
class OptionsTradingManager:
    ...
    def imp_vol_mp_1(self,tickers,S):
    ...
    def specific_option_misprice_1(self,tickers):
    ...
    def imp_vol_mp_2(self,tickers,S):
        ...
        plt.plot(call_skew_2,marker='o',markersize=8,color='green',linewidth=2)
        plt.plot(put_skew_2, marker='o',markersize=8,color='orange',linewidth=2)
        plt.legend([call_skew_2, put_skew_2], ['call_skew 2m', 'put_skew 2m'])
    ...
    def specific_option_misprice_2(self,tickers):
